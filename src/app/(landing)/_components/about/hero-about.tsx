 ...
 * - Mirrors the Services hero layout for visual consistency
 * - Deep blue gradient with subtle wave background
 * - Left: Title + subtitle copy for About
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid max-h-[560px] grid-cols-1 items-center gap-y-10 pt-28 pb-28 md:grid-cols-2">
          ...
          <div className="text-white font-montserrat z-10 mt-10 sm:mt-0">
            <h1 id="about-heading" className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl whitespace-break-spaces md:whitespace-nowrap">
              About Us
            </h1>
            <p className="mt-4 text-lg sm:text-xl md:text-2xl text-white/90 max-w-prose">
              We’re building India’s most trusted destination for instant, transparent, and customer-first gold services.
            </p>
          </div>
