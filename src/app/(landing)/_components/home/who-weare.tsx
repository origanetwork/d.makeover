...
const WhoWeare: React.FC<Props> = (props: Props) => {
  return (
    <section className="relative bg-white/65 py-16 sm:py-20">
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        <p className="mx-auto mt-3 max-w-3xl text-center text-sm sm:text-base font-semibold text-[#0B3C89]">
        ...
        <div className="mt-10 grid grid-cols-1 gap-8 sm:gap-10 xl:gap-12 md:grid-cols-2 lg:grid-cols-3 items-center">
          {/* Left image */}
          <div className="order-1 md:order-1 lg:order-1">
            <div className="overflow-hidden rounded-2xl border-2 border-[#FFCC33] shadow-[0_10px_25px_rgba(1,33,105,0.20)]">
              <Image
          ...
          <div className="order-2 md:order-2 lg:order-2 lg:col-span-2">
              ...
              {items.map((item) => (
                <React.Fragment key={item.title}>
                  ...
                  <div className="flex items-center gap-4">
                    <span
                      className="mt-1 inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-full ring-1 ring-[#0B3C89]/40 text-[#3F3856]"
                      aria-hidden
                    >
                    ...
                    <p className="text-[#3F3856] text-base sm:text-lg md:text-[24px] font-medium  font-montserrat">
                      {item.title}
                    </p>
                  </div>
