 ...
 * - Mirrors the About hero layout for visual consistency
 * - Deep blue gradient with subtle wave background
 * - Left: Title + subtitle copy for Contact
 * - Right: Person image for brand warmth
 * - Accessible semantics with aria-labelledby
 */
const HeroSection: React.FC = () => {
  return (
    <section aria-labelledby="contact-heading" className="relative isolate overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid max-h-[560px] grid-cols-1 items-center gap-y-10 pt-28 pb-28 md:grid-cols-2">
          ...
          <div className="text-white font-montserrat z-10 mt-10 sm:mt-0">
            <h1 id="contact-heading" className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-[50px] whitespace-break-spaces md:whitespace-nowrap">
            Buy Gold with Confidence
            </h1>
            <p className="mt-4 text-lg sm:text-xl md:text-[26px] text-white/90 max-w-prose">
            Trusted. Transparent. Tailored to Your Needs.            </p>
          </div>

          {/* Right: Person image (reusing About image for now) */}
