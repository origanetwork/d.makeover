    ...
    <div ref={containerRef} className="relative">
      ...
      >
        ...
        <div ref={menuRef} className="relative h-12 w-12 overflow-visible" aria-hidden>
          <div className={`dot absolute top-2 left-2 h-[10px] w-[10px] rounded-full ${isOpen ? 'bg-brand-green-500' : 'bg-white'}`} />
          <div className={`dot absolute top-2 right-2 h-[10px] w-[10px] rounded-full ${isOpen ? 'bg-brand-green-500' : 'bg-white'}`} />
          <div className={`dot absolute bottom-2 left-2 h-[10px] w-[10px] rounded-full ${isOpen ? 'bg-brand-green-500' : 'bg-white'}`} />
          <div className={`dot absolute bottom-2 right-2 h-[10px] w-[10px] rounded-full ${isOpen ? 'bg-brand-green-500' : 'bg-white'}`} />
        </div>
      </button>
